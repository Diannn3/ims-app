...
export const floorVisuals = {
  ground: {
    ...
    exits: [
      { x: 70, y: 382, label: 'Main entrance', kind: 'entrance', verificationStatus: 'reference-matched' },
      { x: 1087, y: 328, label: 'Exit marker · unverified', kind: 'emergency', verificationStatus: 'reference-matched' }
    ],
  ...
  second: {
    ...
    exits: [
      { x: 101, y: 286, label: 'Exit marker · unverified', kind: 'emergency', verificationStatus: 'reference-matched' },
      { x: 1078, y: 331, label: 'Exit marker · unverified', kind: 'emergency', verificationStatus: 'reference-matched' }
    ],
    compass: { x: 1090, y: 655 },
